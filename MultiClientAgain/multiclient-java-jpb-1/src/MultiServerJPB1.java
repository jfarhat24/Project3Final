...
public class MultiServerJPB1 {
    ...
    //create vector to hold all clients logged in
    static Vector<ClientHandler> activeClients = new Vector<>();
    //method to check and start connection
    ...
    //creating the connection and store into txt file
        ...
        try {
            ...
            while(true) {
                ...
                if(strReceived.equalsIgnoreCase("hello")) {
                    ...
                    //listen for user input and solve
